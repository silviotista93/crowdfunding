...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_fragment__ = __webpack_require__(35);
...
Vue.use(__WEBPACK_IMPORTED_MODULE_0_vue_fragment__["a" /* Plugin */]);
...
Vue.component('project-messages', __webpack_require__(53));
...
Component.options.__file = "resources/js/components/message/MessagesComponent.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-048f44ae", Component.options)
  } else {
    hotAPI.reload("data-v-048f44ae", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getMessages: function getMessages() {
            ...
            axios.get('/project-message?project_id=' + this.project.id).then(function (response) {
        ...
        enviarMensage: function enviarMensage() {
            var _this2 = this;
            ...
            axios.post('/project-message', {
                ...
                _this2.mensajes.push(response.data);
                _this2.comentario = '';
            }).catch(function (error) {
                console.log(error);
            });
        ...
        return _c("li", { staticClass: "nav-item m-tabs__item" }, [
          _c(
            "a",
            {
              ...
              attrs: {
                "data-toggle": "tab",
                href: "#m_quick_sidebar_tabs_" + tab,
                role: "tab"
              }
            },
            [_vm._v(_vm._s(tab))]
      ...
      _vm._l(_vm.tabs, function(tab) {
        return _c(
          "div",
          {
            ...
            attrs: { id: "m_quick_sidebar_tabs_" + tab, role: "tabpanel" }
          },
          [
            _c(
              "div",
              ...
              [
                _c(
                  "div",
                  { staticClass: "m-messenger__messages m-scrollable" },
                  _vm._l(_vm.mensajes, function(message) {
                    return _c("div", { staticClass: "m-messenger__wrapper" }, [
                      _c(
                        "div",
                        {
                          class:
                            message.id_users !== _vm.user.id
                        ...
                        [
                          _c(
                            ...
                            [
                              ...
                              _c(
                                "div",
                                { staticClass: "m-messenger__message-content" },
                                [
                                  message.id_users !== _vm.user.id
                                    ? _c(
                                        "div",
                                  ...
                                  _c(
                                    "div",
                                    {
                                      staticClass: "m-messenger__message-text"
                                    },
                                    [
                                      _vm._v(
                                        "\n                                            " +
                  ...
                  _c("div", { staticClass: "m-messenger__form-tools" }, [
                    _c(
                      "span",
                      {
                        ...
                        staticStyle: { "background-color": "var(--success)" },
                        on: {
                          click: function($event) {
                            return _vm.enviarMensage()
                          }
                        }
                      },
                      [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-048f44ae", module.exports)
  }
}
