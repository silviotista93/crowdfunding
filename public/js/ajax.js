...
const cBlockUI = function (target, options) {
    var el = $(target);
...
const cUnblockUI = function (target) {
...
const ajax = function (
    ...
    if (blockUI) {
        cBlockUI(selectorElement, options);
    }
    ajx(url, data, function (r) {
        if (blockUI) {
            cUnblockUI(selectorElement);
        }
