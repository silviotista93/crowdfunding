            ...
            <div class="m-portlet__head-tools">
                <ul class="m-portlet__nav">
                    <li class="m-portlet__nav-item">
                        <a href="#" data-toggle="m-tooltip" class="m-portlet__nav-link m-portlet__nav-link--icon" data-direction="left" data-width="auto"
                                        ...
                                        <div class="m-form__section">
                                            <div class="m-form__heading">
                                                <h3 class="m-form__heading-title">
                                                    ...
                                                    <button type="button" data-toggle="modal" id="btn_help_youtube" data-target="#open_help_youtube" class="m-portlet__nav-link btn btn-lg btn-secondary  m-btn m-btn--icon m-btn--icon-only m-btn--pill  m-dropdown__toggle"
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-xl-9 col-lg-9">
                                                    <input type="text" name="url_video" class="form-control m-input iframe_add_proyecto required" placeholder="link video" value=""
                                                        id="txtFrame" pattern=".+(youtube.com\/watch).+v=.+">
                                            ...
                                            <div class="form-group m-form__group row">
                                                <label class="col-xl-2 col-lg-2 col-form-label">* {{ __('imagen') }}:</label>
                                                <div class="col-xl-9 col-lg-9">
                                                    <div class="m-dropzone dropzone m-dropzone--success" action="" id="m-dropzone-three">
                                                        <div class="m-dropzone__msg dz-message needsclick">
                                                            <h3 class="m-dropzone__msg-title">{{ __('agrega_imagen_proyecto') }}</h3>
                                        ...
                                        <div class="m-form__section m-form__section--first">
                                            ...
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-12 m-form__group-sub">
                                                    ...
                                                    <textarea class="form-control m-input m-input--solid corta_descr_add_proyecto required" id="descripcionProyecto" name="short_description"
                                                        rows="8">{{ old('biography') }}</textarea>                                                    {!! $errors->first('biography','
...
@endphp @if($contProject == 0 & $datos != null) @forelse ($datos as $quest)
                                        ...
                                        @empty {{__('no_hay_preguntas') }} @endforelse @else {{__('no_hay_preguntas') }} @endIf
                                    ...
                                    <div class="m-wizard__form-step" id="m_wizard_form_step_4">
                                        ...
                                        <div class="m-accordion m-accordion--default" id="m_accordion_1" role="tablist">
                                            ...
                                            <div class="m-accordion__item active">
                                                ...
                                                <div class="m-accordion__item-body collapse show" id="m_accordion_1_item_1_body" class=" " role="tabpanel" aria-labelledby="m_accordion_1_item_1_head"
                                                    ...
                                                    <div class="tab-content active  m--padding-30">
                                                        <div class="m-form__section m-form__section--first">
                                                            ...
                                                            <div class="form-group m-form__group row">
                                                                <div class="col-xl-9 col-lg-12 caja_video_youtube_add_proyect">
                                                                    ...
                                                                    <iframe width="560" height="315" id="videoYoutube" data-url="https://www.youtube.com/embed/" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                                                                        allowfullscreen>
                                                                        </iframe>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="m-form__section">
                                                            ...
                                                            <div class="form-group m-form__group row text-center">
                                                                <div class="col-xl-9 col-lg-12 text-center caja_image_add_proyect">
                                                                    <img id="img_add_proyect" class="text-center" width="100%" src="" alt="">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="m-accordion__item">
                                                ...
                                                <div class="m-accordion__item-body collapse" id="m_accordion_1_item_2_body" class=" " role="tabpanel" aria-labelledby="m_accordion_1_item_2_head"
                                                    ...
                                                    <div class="tab-content  m--padding-30">
                                                        <div class="m-form__section m-form__section--first">
                                                            <div class="m-form__heading">
                                                                <h4 class="m-form__heading-title">{{ __('informacion_general_2') }}</h4>
                                                            </div>
                                                            <div class="form-group m-form__group m-form__group--sm row">
                                                                <label class="col-xl-4 col-lg-4 col-form-label">{{ __('nombre_proyecto') }}:</label>
                                                                <div class="col-xl-8 col-lg-8">
                                                                    <span class="m-form__control-static nombre_project_confirmacion"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group m-form__group m-form__group--sm row">
                                                                <label class="col-xl-4 col-lg-4 col-form-label">{{ __('corta_descripcion') }}:</label>
                                                                <div class="col-xl-8 col-lg-8">
                                                                    <span class="m-form__control-static descripcion_corta_confirmacion"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="m-separator m-separator--dashed m-separator--lg"></div>
                                                        <div class="m-form__section">
                                                            <div class="m-form__heading">
                                                                <h4 class="m-form__heading-title">{{ __('acerca_proyecto') }}</h4>
                                                            </div>
                                                            <div class="form-group m-form__group m-form__group--sm row">
                                                                <label class="col-xl-4 col-lg-4 col-form-label">{{ __('genero') }}:</label>
                                                                <div class="col-xl-8 col-lg-8">
                                                                    <span class="m-form__control-static genero_musical_confirmacion"></span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group m-form__group m-form__group--sm row">
...
<!--=====================================
		MODAL AYUDA YOUTUBE
    ======================================-->
<div class="modal fade" id="open_help_youtube" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
