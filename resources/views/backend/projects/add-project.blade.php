                                ...
                                <form method="post" action="{{ route('add.store.project') }}"
                                    ...
                                    <div class="m-portlet__body m-portlet__body--no-padding">
                                        ...
                                        <div class="m-wizard__form-step m-wizard__form-step--current"
                                            ...
                                            <img src="/backend/assets/app/media/img/projects/logo_youtube.png"
                                                 width="15%" alt="Logo youtube">
                                            <div class="m-form__section">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <label class="col-xl-2 col-lg-2 col-form-label">* {{ __('imagen') }}
                                                        :</label>
                                                    <div class="col-xl-9 col-lg-9">
                                                        ...
                                                        <span
                                                            class="m-form__help">{{ __('info_add_project_image') }}</span>
                                    ...
                                    ======================================-->
                                        <div class="m-wizard__form-step" id="m_wizard_form_step_2">
                                            <div class="m-form__section m-form__section--first">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <div class="col-lg-12">
                                                        <label class="form-control-label"
                                                               form="nombreProyecto">* {{ __('nombre_proyecto') }}
                                                            :</label>
                                                        <input type="text" name="title"
                                                               class="form-control m-input title_add_proyecto required"
                                                               id="nombreProyecto" placeholder=""
                                                               value="">
                                                        <span
                                                            class="m-form__help">{{ __('help_nombre_proyecto') }}</span>
                                                    </div>
                                                </div>

                                                <div class="col-lg-6 m-form__group-sub">
                                                    <label class="form-control-label"
                                                           form="category_add_proyecto">* {{ __('select_categoria') }}
                                                        :</label>
                                                    <select name="tCategory_id"
                                                        ...
                                                        @foreach($tipoCategorias as $tCategorie)
                                                            <option
                                                                value="{{ $tCategorie->id }}">{{__($tCategorie->name) }}</option>
                                                        @endforeach
                                                ...
                                                <div class="col-lg-6 m-form__group-sub cont_solista"
                                                     style="display:none">
                                                    <label class="form-control-label"
                                                           form="select_solista">* {{ __('select_solista') }}:</label>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="exampleModalLongTitle">{{ __('integrantes_grupo') }}</h5>
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="m-form__section m-form__section--first"
                                                                    ...
                                                                    <div class="form-group m-form__group row">
                                                                        <div class="col-lg-12">
                                                                            <label class="form-control-label"
                                                                                   form="nombreIntegrante">* {{ __('nombre') }}
                                                                                :</label>
                                                                    ...
                                                                    <div class="form-group m-form__group row">
                                                                        <div class="col-lg-12">
                                                                            <label class="form-control-label"
                                                                                   form="rolIntegrante">* {{ __('rol') }}
                                                                                :</label>
                                                                            <input type="text" name="rol[]"
                                                                                   class="form-control m-input title_add_proyecto required"
                                                                                   id="rolIntegrante" placeholder=""
                                                                                   value="">
                                                                            <span
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <div class="col-lg-12 m-form__group-sub">
                                                        <label class="form-control-label"
                                                               form="descripcionProyecto">* {{ __('corta_descripcion') }}
                                                            :</label>
                                                        <textarea
                                            ...
                                            <div class="m-form__section">
                                                ...
                                                <div class="form-group m-form__group row">
                                                    <div class="col-lg-6 m-form__group-sub">
                                                        <label class="form-control-label"
                                                               form="category_id">* {{ __('select_genero') }}:</label>
                                                        <select name="category_id"
                                                            ...
                                                            @foreach($categories as $categorie)
                                                                <option
                                                                    value="{{ $categorie->id }}">{{ $categorie->category }}</option>
                                                            @endforeach
                                                            {!! $errors->first('category_id','<div class="form-control-feedback">*:message</div>')!!}
                                                        </select>
                                                    ...
                                                    <div class="col-lg-6 m-form__group-sub">
                                                        <label class="form-control-label"
                                                               form="costo_proyecto">* {{ __('costo_proyecto') }}
                                                            :</label>
                                                        <div class="input-group">
                                                            ...
                                                            <input type="hidden" name="price" class="valorDBProject"
                                                                   value="">
                                                        </div>
                                        ...
                                        <div class="m-wizard__form-step" id="m_wizard_form_step_3">
                                            ...
                                            {{-- {{dd($contProject)}} --}} {{-- {{dd($question)}} --}}
                                            @php $datos=null; if(isset($question[0])){ $datos=json_decode($question[0]->question);
                                        }
                                            ...
                                            <div class="m-accordion m-accordion--default" id="m_accordion_1"
                                                ...
                                                <div class="m-accordion__item active">
                                                    <div class="m-accordion__item-head" role="tab"
                                                        ...
                                                        <span
                                                            class="m-accordion__item-title">1. {{ __('audio_visual') }}</span>
                                                    ...
                                                    <div class="m-accordion__item-body collapse show"
                                                        ...
                                                        <div class="tab-content active  m--padding-30">
                                                            ...
                                                            <div
                                                                class="m-separator m-separator--dashed m-separator--lg"></div>
                                                            <div class="m-form__section">
                                                                <div class="m-form__heading">
                                                                    <h3 class="m-form__heading-title">
                                                                        {{ __('tu_imagen') }}
                                                ...
                                                <div class="m-accordion__item">
                                                    <div class="m-accordion__item-head collapsed" role="tab"
                                                        ...
                                                        <span
                                                            class="m-accordion__item-title">2. {{ __('informacion_general') }}</span>
                                                        <span class="m-accordion__item-mode"></span>
                                                    </div>
                                                        ...
                                                        <div class="tab-content  m--padding-30">
                                                            <div class="m-form__section m-form__section--first">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <label
                                                                        class="col-xl-4 col-lg-4 col-form-label">{{ __('nombre_proyecto') }}
                                                                        :</label>
                                                                ...
                                                                <div
                                                                    class="form-group m-form__group m-form__group--sm row">
                                                                    <label
                                                                        class="col-xl-4 col-lg-4 col-form-label">{{ __('corta_descripcion') }}
                                                                        :</label>
                                                                    <div class="col-xl-8 col-lg-8">
                                                                        <span
                                                            ...
                                                            <div class="m-form__section">
                                                                ...
                                                                <div
                                                                    class="form-group m-form__group m-form__group--sm row">
                                                                    <label
                                                                        class="col-xl-4 col-lg-4 col-form-label">{{ __('genero') }}
                                                                        :</label>
                                                                    <div class="col-xl-8 col-lg-8">
                                                                        <span
                                                                ...
                                                                <div
                                                                    class="form-group m-form__group m-form__group--sm row">
                                                                    <label
                                                                        class="col-xl-4 col-lg-4 col-form-label">{{ __('costo_proyecto') }}
                                                                        :</label>
                                                                    <div class="col-xl-8 col-lg-8">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <video width="100%" class="video_help_add_project_youtube" loop="true" autoplay="true">
                    <source src="/backend/assets/app/media/video/project/video_youtube_add_project.mov"
                            type="video/mp4">
                </video>
            </div>
        </div>
